...
<table>
  <tr>
    ...
    <td align="center" width="96">
      ...
      <div style="display: flex; align-items: center; gap: 8px; padding: 8px 8px; background: #e3f2fd; border-radius: 8px;">
